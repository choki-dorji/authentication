...
class Fileupload(models.Model):
    name = models.OneToOneField(NewUser, related_name = "files", on_delete=models.CASCADE)
    file = models.FileField(null = True, editable = True, upload_to='photo_directory_path')
